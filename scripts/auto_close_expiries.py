...
# ── למה אין כאן שער יום-מסחר ──────────────────────────────────────────────
# בכוונה. הטריגר של הסקריפט הזה הוא **קיום הסטלמנט ב-DB**, לא הזמן — ולכן הוא
# בטוח ואידמפוטנטי מטבעו: ביום שאין בו סטלמנט חדש הוא פשוט לא מוצא מה לסגור.
# חסימה לפי יום-מסחר הייתה מוסיפה מצב כשל חדש (סטלמנט שנכתב באיחור לא ייסגר
