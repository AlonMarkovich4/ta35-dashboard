...
import { getOptionChain, getCurrentDecision } from "@/lib/data";
...
export default async function UpcomingPage() {
  ...
  const [first, decision] = await Promise.all([getOptionChain(), getCurrentDecision()]);
  const chains = first
  ...
  return <UpcomingView chains={chains} decision={decision} />;
}
