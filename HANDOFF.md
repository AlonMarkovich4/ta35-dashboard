...
| `tase_putcall` | snapshot יחיד: `fetch_date=2026-07-31 17:16`, `trade_date=30/07` (T-1 תקין), 362 שורות, 4 פקיעות |
| `tase_putcall_history` | 12,516 שורות · 22/05 → 31/07 |
| `paper_trades` | 34 סגורות · **4 פתוחות** |
...
| id | תיק | פקיעה | מצב |
|---|---|---|---|
| **36** | 8 | 2026-07-23 | **יתומה מוכרת** — תשעה באב, אין ולא יהיה סילוק |
| 41 | 8 | 2026-08-04 | פקיעה עתידית, תקין |
| 42 | 8 | 2026-08-05 | פקיעה עתידית, תקין |
| 43 | 8 | 2026-08-06 | פקיעה עתידית, תקין |
...
## 3. אירוע תשעה באב — מה קרה ומה תוקן
...
### 3.2 מה תוקן (31/07–01/08) — 5 קומיטים
...
> **המערכת לא הפסיקה לאסוף נתונים. היא הפסיקה לדעת שהיא לא מקבלת אותם.**
...
**שני כללים שנגזרים מזה, ושכדאי להחזיק בהם:**
